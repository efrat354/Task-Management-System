...
//Add a new exception class in order to take care of cases of not exist input such as an entity with an ID number that does not exist in the list
[Serializable]
public class DalDoesNotExistException : Exception
{
    public DalDoesNotExistException(string? message) : base(message) { }
}
//Add a new exception class in order to take care of cases of input which already exists such as an entity with an ID number that already exists in the list
